		...
		<div class="container-fluid">
			<form method="post" enctype="multipart/form-data">
				...
				ob_start();
					include 'conn.php';
					$ids = $_GET['id'];
					$showquery = " SELECT * FROM `restaurants` WHERE id=${ids} ";
					...
					if(isset($_POST['submit'])){
						...
						$updatequery = " UPDATE `restaurants` SET `email`='$email', `mobile`='$mobile', `address`='$address', `availibility`='$availibility', `capacity`='$capacity', `offers`='$offers' WHERE id=$idupdate ";
						header("location:Personal_Profile_Restaurant.php");
 				...
 				<div class="row">
					...
					<div class="col-8">
						<div class="main-form">
							...
							<div class="form-group">
								<label>Offers</label>
								<textarea name="offers" class="form-control" autocomplete="off"  ><?php echo $arrdata['offers'];?></textarea>
							</div>
