		...
		<div class="container-fluid">
			...
			<div class="container-fluid second_div">
				...
				<div class="row">
					<div class="col-2"></div>
					<div class="col-1">
						<a href="DetailsEdit_Seminar.php?id=<?php echo $res['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="edit your details"><i class="fa fa-edit" aria-hidden="true"  style="font-size: 2vw;"></i></a>
					</div>
				...
				<div class="row">
					<div class="col-1"></div>
					<div class="col-1">
						<a href="PhotoEdit_Seminar.php?id=<?php echo $res['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="change pictures"><i class="fa fa-edit" aria-hidden="true"  style="font-size: 2vw;"></i></a>
					</div>
					<div class="col-8">
						<div class="row">
