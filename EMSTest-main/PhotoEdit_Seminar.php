				...
				ob_start();
					...
					if(isset($_POST['submit'])){
						...
						$fileerror8 = $file8['error'];
							...
							$updatequery = " UPDATE `seminar` SET `pp`='$destfile' ,`pp1`='$destfile1' ,`pp2`='$destfile2' ,`pp3`='$destfile3' ,`pp4`='$destfile4' ,`pp5`='$destfile5', `pp6`='$destfile6' ,`pp7`='$destfile7' ,`pp8`='$destfile8' WHERE id=$idupdate ";
