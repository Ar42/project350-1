...
if($usernamecount>0){
	header('location:Personal_Profile_CC.php?CC_Name=$name');
}
?>
<!DOCTYPE html>
<html>
					...
					<div class="col-8">
						<div class="main-form">
							<div class="form-group">
								<label>Name</label>
								<input type="text" name="name" class="form-control" placeholder="Community Centre Name(must be same as username)" value="<?php echo $_SESSION['username']?>" style="margin-right: 10vw;"  autocomplete="off"  >
							</div>
							<div class="form-group">
