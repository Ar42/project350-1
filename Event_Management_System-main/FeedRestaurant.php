...
<html>
	...
	<body>
		<img src="images/restaurant_sign.jpg" style="width: 100%; height: 250px">
		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<tr class="bg-danger text-white text-center">
					...
					<th  style="font-size: 2vw; color: black; background-color: lightblue ; border-radius: 13px">Restaurant</th>
